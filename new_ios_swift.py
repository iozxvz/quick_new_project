...
temp_path = f"{script_directory}/TEMPLATE_IOS_SWIFT"
...
os.rename(f"{proj_name}/TEMPLATE_IOS_SWIFT", f"{proj_name}/{proj_name}")
os.rename(f"{proj_name}/TEMPLATE_IOS_SWIFT.xcodeproj", f"{proj_name}/{proj_name}.xcodeproj")
